...
function createCards(data) {
    ...
    if (data && data.length > 0) {
        ...
        data.forEach((item, index) => {
            ...
            image.src = 'https://media.wired.com/photos/5cdefc28b2569892c06b2ae4/master/w_2560%2Cc_limit/Culture-Grumpy-Cat-487386121-2.jpg'; // Usando a URL da imagem fornecida pela API
            ...
            modalItemIdade.innerHTML = 'Data de Nascimento: <b>' + item.dataDeNascimento + '</b>';
            ...
            modalItemComportamento.innerHTML = 'Comportamento: <b>' + item.comportamento + '</b>';
            ...
            modalItemCastrado.innerHTML = 'Castrado: <b>' + (item.castrado ? 'Sim' : 'Não') + '</b>';

            const modalItemVacinado = document.createElement('li');
            modalItemVacinado.classList.add('list-group-item');
            modalItemVacinado.innerHTML = 'Vacinado: <b>' + (item.vacinado ? 'Sim' : 'Não') + '</b>';
            ...
            modal.appendChild(modalDialog);
                       ...
                       modalEditButton.addEventListener('click', () => {
                           ...
                           const editModal = new bootstrap.Modal(document.getElementById('modal2'));
                           editModal.show();
                       });
